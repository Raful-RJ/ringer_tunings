...
ref_path     = '/home/rafael.vianna/tunings/versions/v2/referenceFiles/worlx/mc16_13TeV.sgn.ph_medium.gammajet.bkg.vetoph_loose.dijet_et%i_eta%i.ref.pic.gz'
config_path  = '/home/rafael.vianna/tunings/versions/v2/configFiles/et%i_eta%i.job_config.Zrad_v2.n2to5.10sorts.10inits.r0/*'
...
# loop over the bins
#(list(product(range(0,1), range(0,4))))
bins = [(0,1),(0,2),(0,3),(0,4)]
for iet, ieta in bins:
